...
from transformers import LlamaForCausalLM, LlamaTokenizer, Trainer, TrainingArguments, DataCollatorWithPadding, PretrainedConfig

load_dotenv()
hf_token = os.getenv("HF_TOKEN")

class CustomLlamaForClassification(torch.nn.Module):
...
def train(
    ...
    model = CustomLlamaForClassification(model)
